...
public:
    ...
    static InvokeResult success(const std::vector<Embedding> &embeddings = std::vector<Embedding>());
    static InvokeResult failure(const std::string &description, const std::vector<Embedding> &embeddings = std::vector<Embedding>());
